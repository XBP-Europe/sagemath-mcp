...
- `tools/` - The 39 tools and 3 resources by domain: `session`, `core`, `calculus`, `algebra`, `discrete`, `stats`, `plotting`, `diagnostics`. A module missing from `tools/__init__.py` registers nothing.
