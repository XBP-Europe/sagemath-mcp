...
persistence primitives are not. The policy accepts **98.8% of SageMath's own
432,878 documented doctest examples** (4,366 in-scope refusals, every one
attributed to a named rule; 98.9% of 433,289 on the passagemath runtime) while
