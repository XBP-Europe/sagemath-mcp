...
**Current state (released as v0.8.0):**
...
failed that test has been fixed. **Re-measured 2026-09-17 on `main`:** 99.08%
(370,966 accepted, 3,462 refused, 58,268 out of scope by design) on SageMath
10.9, and 99.16% of 433,289 examples on passagemath 10.8.11; the enforced floor
...
- [x] **Passagemath runtime for install footprint.** *Done, 2026-09-07; pin
      ...
      runs the whole suite plus the doctest corpus sweep against it (99.16%
      acceptance on 10.8.11, versus 99.08% on monolithic 10.9). The pin is exact
