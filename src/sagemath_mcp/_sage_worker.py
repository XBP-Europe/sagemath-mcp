...
_DANGEROUS_SAGE_NAME_LIST: frozenset[str] = frozenset({
    ...
    "Sh", "Singular", "SnapPy", "SnapPyHP", "TestAppendList", "TestAppendNonlist", "TestBuild",
    "TestBuildSetstate", "TestGlobalFunnyName", "TestGlobalNewName", "TestGlobalOldName",
    "TestReduceGetinitargs", "TestReduceNoGetinitargs", "add_attached_file", "atomic_dir",
    "atomic_write", "attach", "attached_files", "attrcall", "attributes", "axiom",
    "call_method", "call_pickled_function", "check_pickle", "clean_namespace", "code_ctor",
    "compile_and_load", "cython", "cython_compile", "cython_import", "cython_import_all",
    "cython_lambda", "db", "db_save", "detach", "dir_with_other_class", "dummy_integrate",
    "dumps", "ecm", "edit", "edit_devel", "ensure_startup_finished", "explain_pickle",
    "explain_pickle_string", "file_and_line", "find_objects_from_name", "finish_startup",
    "fortran", "four_ti_2", "fricas", "frobby", "gap", "gap3", "gap3_version",
    "gap_reset_workspace", "genus2reduction", "get_display_manager", "get_remote_file",
    "get_star_imports", "get_test_shell", "get_verbose", "get_verbose_files", "getattr_debug",
    "getattr_from_other_class", "gfan", "giac", "gnuplot", "gp", "gp_version",
    "import_statement_string", "import_statements", "init", "inline_plots",
    "installed_packages", "interface_shell_embed", "interfaces", "is_during_startup",
    ...
    "singular", "singular_version", "snappy", "snappyhp", "spkg_type", "spyx_tmp", "sr_to_max",
    "stdout_to_string", "tachyon_rt", "template_fields", "test_fake_startup", "test_max_equal",
    "test_max_notequal", "test_max_relation", "tmp_dir", "tmp_filename", "trace", "type_debug",
    "unpickleMethod", "unpickleModule", "unpickle_all", "unpickle_appends", "unpickle_build",
