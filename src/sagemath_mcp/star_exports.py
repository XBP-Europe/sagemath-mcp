...
STAR_EXPORTS: dict[str, frozenset[str]] = {
    ...
    "sage.rings.ideal": frozenset({
        ...
        "Katsura", "MonoidElement", "Rings", "Sequence", "op_NE", "rich_to_bool"
    }),
    "sage.structure.element": frozenset({
        ...
        "is_RingElement", "is_Vector", "make_element", "parent", "rename_keyword",
        "revop", "rich_to_bool", "rich_to_bool_sgn", "richcmp", "richcmp_not_equal",
        "sage_wraps"
    }),
    ...
    "sage.modular.modform.space": frozenset({
        ...
        "WARN", "ZZ", "cached_method", "contains_each", "gcd", "rich_to_bool",
        "richcmp", "richcmp_method", "richcmp_not_equal", "zero_matrix"
    }),
    ...
    "sage.rings.integer": frozenset({
        ...
        "make_integer", "n_factor_to_list", "new_gen_from_integer", "objtogen",
        "parent", "pari_divisors_small", "pari_gen", "pari_is_prime",
